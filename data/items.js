...
const ITEMS = {
  ...
  headgear: [
    ...
    { id: "hat-wizard",         name: "Topi Wizard",       rarity: "rare",      priceCoins: 150, img: "assets/items/hat-wizard.png", rect: { x: 42, y: 0, w: 116, h: 88, aspect: "xMidYMid meet" } },
    { id: "hat-crown-gold",     name: "Mahkota Emas",      rarity: "legendary", priceGems:  25, img: "assets/items/hat-crown-gold.png", rect: { x: 52, y: 4, w: 96, h: 68, aspect: "xMidYMid meet" } },
    { id: "hat-viking-helmet",  name: "Helmet Viking",     rarity: "rare",      priceCoins: 150, img: "assets/items/hat-viking-helmet.png", rect: { x: 40, y: 2, w: 120, h: 78, aspect: "xMidYMid meet" } },
    ...
    { id: "hat-knight-helmet",  name: "Helmet Kesatria",   rarity: "legendary", priceGems:  25, img: "assets/items/hat-knight-helmet.png", rect: { x: 48, y: 10, w: 104, h: 78, aspect: "xMidYMid meet" } },
    { id: "hat-unicorn-horn",   name: "Tanduk Unicorn",    rarity: "legendary", priceGems:  25, img: "assets/items/hat-unicorn-horn.png", rect: { x: 70, y: 0, w: 60, h: 70, aspect: "xMidYMid meet" } },
    { id: "hat-bunny-ears",     name: "Telinga Arnab",     rarity: "common",    priceCoins: 30,  img: "assets/items/hat-bunny-ears.png", rect: { x: 48, y: 0, w: 104, h: 80, aspect: "xMidYMid meet" } },
  ],
  ...
  cape: [
    ...
    { id: "cape-royal-ermine",  name: "Cloak Diraja",     rarity: "legendary", priceGems:  25, img: "assets/items/cape-royal-ermine.png", rect: { x: 18, y: 50, w: 164, h: 130, aspect: "xMidYMid meet" } },
    ...
    { id: "cape-angel-wings",   name: "Sayap Malaikat",   rarity: "legendary", priceGems:  25, img: "assets/items/cape-angel-wings.png", rect: { x: 10, y: 40, w: 180, h: 140, aspect: "xMidYMid meet" } },
  ],
  ...
  hair: [
    ...
    { id: "hair-long-straight-black", name: "Lurus Panjang Hitam",  rarity: "common",  priceCoins: 30,  img: "assets/items/hair-long-straight-black.png", rect: { x: 34, y: 16, w: 132, h: 120, aspect: "xMidYMid meet" } },
    ...
    { id: "hair-ponytail-blonde",  name: "Kuncir Perang",        rarity: "common",    priceCoins: 30,  img: "assets/items/hair-ponytail-blonde.png", rect: { x: 36, y: 14, w: 128, h: 112, aspect: "xMidYMid meet" } },
    { id: "hair-pigtails-ginger",  name: "Tokok Jinjang",        rarity: "rare",      priceCoins: 100, img: "assets/items/hair-pigtails-ginger.png" },
    { id: "hair-afro-black",       name: "Afro Hitam",           rarity: "common",    priceCoins: 30,  img: "assets/items/hair-afro-black.png", rect: { x: 30, y: 10, w: 140, h: 110, aspect: "xMidYMid meet" } },
    ...
    { id: "hair-viking-blonde",    name: "Viking Perang",        rarity: "legendary", priceGems:  25, img: "assets/items/hair-viking-blonde.png", rect: { x: 32, y: 8, w: 136, h: 108, aspect: "xMidYMid meet" } },
    { id: "hair-regal-white",      name: "Diraja Putih",         rarity: "legendary", priceGems:  25, img: "assets/items/hair-regal-white.png" },
    { id: "hair-rainbow",          name: "Pelangi",              rarity: "legendary", priceGems:  25, img: "assets/items/hair-rainbow.png", rect: { x: 30, y: 12, w: 140, h: 112, aspect: "xMidYMid meet" } },
  ...
  shoes: [
    ...
    { id: "shoes-boots-black",    name: "But Hitam",         rarity: "common",    priceCoins: 40,  img: "assets/items/shoes-boots-black.png", rect: { x: 56, y: 164, w: 88, h: 36, aspect: "xMidYMid meet" } },
    { id: "shoes-hiking-brown",   name: "But Hiking",        rarity: "common",    priceCoins: 40,  img: "assets/items/shoes-hiking-brown.png" },
    { id: "shoes-rainboots-yellow",name:"But Hujan Kuning",  rarity: "common",    priceCoins: 40,  img: "assets/items/shoes-rainboots-yellow.png", rect: { x: 56, y: 164, w: 88, h: 36, aspect: "xMidYMid meet" } },
